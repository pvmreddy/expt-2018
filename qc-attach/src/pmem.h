...
@param [in] id    PMEM id for the allocation.
...
@notes.  Creating remote handles requires the calling process to have the
...
@notes.  The calling process must have "PROCMGR_AID_MEM_PHYS" ability on
the memory regions for this call to succeed.
